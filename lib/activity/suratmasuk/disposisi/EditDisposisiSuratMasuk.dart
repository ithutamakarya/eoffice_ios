...
class EditDisposisiSuratMasuk extends StatefulWidget {
  final dataId;

  final bool horizontal;

  EditDisposisiSuratMasuk(this.dataId, {this.horizontal = true});

  EditDisposisiSuratMasuk.vertical(this.dataId) : horizontal = false;

  EditDisposisiSuratMasukState createState() =>
      new EditDisposisiSuratMasukState(dataId);
}

class EditDisposisiSuratMasukState extends State<EditDisposisiSuratMasuk> {
  final dataId;
  final bool horizontal;

  EditDisposisiSuratMasukState(this.dataId, {this.horizontal = true});

  EditDisposisiSuratMasukState.vertical(this.dataId) : horizontal = false;
      ...
      if (_mySelection == "Selesai" || _mySelection == "selesai") {
        ...
        http.post(
          ...
          if (success) {
            pr.hide();
            setState(() {
              DisposisiSuratMasukState.refreshing();
        ...
        if (date.toString() == "null") {
          ...
          datePost = format.format(DateTime.parse(date.toString())).toString();
