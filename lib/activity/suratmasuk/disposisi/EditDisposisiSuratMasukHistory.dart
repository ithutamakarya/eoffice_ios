...
class EditDisposisiSuratMasukHistory extends StatefulWidget {
  final dataId;

  final bool horizontal;

  EditDisposisiSuratMasukHistory(this.dataId, {this.horizontal = true});

  EditDisposisiSuratMasukHistory.vertical(this.dataId) : horizontal = false;

  EditDisposisiSuratMasukHistoryState createState() =>
      new EditDisposisiSuratMasukHistoryState(dataId);
}

class EditDisposisiSuratMasukHistoryState
    extends State<EditDisposisiSuratMasukHistory> {
  final dataId;
  final bool horizontal;

  EditDisposisiSuratMasukHistoryState(this.dataId, {this.horizontal = true});

  EditDisposisiSuratMasukHistoryState.vertical(this.dataId)
      : horizontal = false;
      ...
      if (_mySelection == "Selesai" || _mySelection == "selesai") {
        ...
        http.post(
          ...
          if (success) {
            pr.hide();
            setState(() {
              DisposisiSuratMasukHistoryState.refreshing();
