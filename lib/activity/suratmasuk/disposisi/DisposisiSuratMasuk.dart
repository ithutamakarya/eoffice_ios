...
import 'package:eoffice/activity/suratmasuk/disposisi/DisposisiSuratMasukHistory.dart';
...
class DisposisiSuratMasukRoute extends CupertinoPageRoute {
  DisposisiSuratMasukRoute()
      : super(builder: (BuildContext context) => new DisposisiSuratMasuk());
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    return new FadeTransition(opacity: animation, child: new DisposisiSuratMasuk());
  }
}

class DisposisiSuratMasuk extends StatefulWidget {
  static const String routeName = "/DisposisiSuratMasuk";

  @override
  DisposisiSuratMasukState createState() => DisposisiSuratMasukState();

}

class DisposisiSuratMasukState extends State<DisposisiSuratMasuk> with WidgetsBindingObserver {
  ...
  static Future<DisposisiSuratModel> makeRequest() async {
    ...
    final response =
    await http.get(URL_DOMAIN + '/api/masuk/disposisi?page=' + refreshList.toString() + '&q=' + query + '&token=' +loginToken);
                                ...
                                child: new ListTile(
                                    ...
                                    onTap: () {
                                      if ('${items[i].satker_penerima}' == satkerLogin) {
                                        ...
                                        Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context) => new EditDisposisiSuratMasuk('${items[i].id}')));
                                      } else {
                                        Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context) => new DetailSuratMasuk('${items[i].masuk_id}')));
                                      }
                                    }
