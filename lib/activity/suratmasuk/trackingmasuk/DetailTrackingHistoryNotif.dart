...
class DetailTrackingHistoryNotif extends StatefulWidget {
  final data;
  final dataUuid;

  final bool horizontal;
  DetailTrackingHistoryNotif(this.dataUuid, this.data, {this.horizontal = true});
  DetailTrackingHistoryNotif.vertical(this.dataUuid, this.data): horizontal = false;
  DetailTrackingHistoryNotifState createState() => new DetailTrackingHistoryNotifState(dataUuid, data);
}

class DetailTrackingHistoryNotifState extends State<DetailTrackingHistoryNotif> {
  ...
  DetailTrackingHistoryNotifState(this.dataUuid, this.data, {this.horizontal = true});

  DetailTrackingHistoryNotifState.vertical(this.dataUuid, this.data): horizontal = false;
  ...
  Future<DetailTrackingSuratMasukNew> makeRequest() async {
    ...
    final response =
    await http.get(URL_DETAIL_TRACKING_SURAT_MASUK + data.toString() +"?token=" +loginToken+"&uuid="+dataUuid);
