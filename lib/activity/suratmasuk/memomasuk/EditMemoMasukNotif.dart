...
class EditMemoMasukNotif extends StatefulWidget {
  final dataId;
  final dataUuid;

  final bool horizontal;

  EditMemoMasukNotif(this.dataUuid, this.dataId, {this.horizontal = true});

  EditMemoMasukNotif.vertical(this.dataUuid, this.dataId) : horizontal = false;

  EditMemoMasukNotifState createState() =>
      new EditMemoMasukNotifState(dataUuid, dataId);
}

class EditMemoMasukNotifState extends State<EditMemoMasukNotif> {
  final dataId;
  final dataUuid;

  final bool horizontal;

  EditMemoMasukNotifState(this.dataUuid, this.dataId, {this.horizontal = true});

  EditMemoMasukNotifState.vertical(this.dataUuid, this.dataId)
      : horizontal = false;
  ...
  Future<DetailMemoMasukModel> makeRequest() async {
    ...
    final response = await http.get(URL_DETAIL_MEMO_MASUK +
        dataId.toString() +
        "?token=" +
        loginToken +
        "&uuid=" +
