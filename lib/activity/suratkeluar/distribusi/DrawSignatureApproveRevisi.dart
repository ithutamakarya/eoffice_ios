...
class DrawSignatureApproveRevisiRoute extends CupertinoPageRoute {
  final dataId, dataCatatan;

  final bool horizontal;

  DrawSignatureApproveRevisiRoute(
      this.dataId, this.dataCatatan, this.horizontal)
      : super(
            builder: (BuildContext context) =>
                new DrawSignatureApproveRevisi(dataId, dataCatatan));
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    return new FadeTransition(
        opacity: animation,
        child: new DrawSignatureApproveRevisi(dataId, dataCatatan));
  }
}

class DrawSignatureApproveRevisi extends StatefulWidget {
  static const String routeName = "/DrawSignatureApproveRevisi";

  final dataId, dataCatatan;
  final bool horizontal;

  DrawSignatureApproveRevisi(this.dataId, this.dataCatatan,
      {this.horizontal = true});

  DrawSignatureApproveRevisi.vertical(this.dataId, this.dataCatatan)
      : horizontal = false;
  @override
  DrawSignatureApproveRevisiState createState() =>
      DrawSignatureApproveRevisiState(dataId, dataCatatan);
}

class DrawSignatureApproveRevisiState extends State<DrawSignatureApproveRevisi>
  ...
  DrawSignatureApproveRevisiState(this.dataId, this.dataCatatan,
      {this.horizontal = true});

  DrawSignatureApproveRevisiState.vertical(this.dataId, this.dataCatatan)
      : horizontal = false;
