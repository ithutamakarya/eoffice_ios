...
class EditDistribusiSuratKeluar extends StatefulWidget {
  final dataId;

  final bool horizontal;

  EditDistribusiSuratKeluar(this.dataId, {this.horizontal = true});

  EditDistribusiSuratKeluar.vertical(this.dataId) : horizontal = false;

  EditDistribusiSuratKeluarState createState() =>
      new EditDistribusiSuratKeluarState(dataId);
}

class EditDistribusiSuratKeluarState extends State<EditDistribusiSuratKeluar> {
  final dataId;
  final bool horizontal;

  EditDistribusiSuratKeluarState(this.dataId, {this.horizontal = true});

  EditDistribusiSuratKeluarState.vertical(this.dataId) : horizontal = false;
  ...
  Future<EditDistribusiSuratKeluarModel> makeRequest() async {
    ...
    final response = await http.get(
        URL_EDIT_DISTRIBUSI_SURAT + dataId.toString() + "?token=" + loginToken);
