...
class DetailTrackingSuratKeluarHistory extends StatefulWidget {
  final data;
  final bool horizontal;
  DetailTrackingSuratKeluarHistory(this.data, {this.horizontal = true});
  DetailTrackingSuratKeluarHistory.vertical(this.data): horizontal = false;
  DetailTrackingSuratKeluarHistoryState createState() => new DetailTrackingSuratKeluarHistoryState(data);
}

class DetailTrackingSuratKeluarHistoryState extends State<DetailTrackingSuratKeluarHistory> {

  final data;
  final bool horizontal;

  DetailTrackingSuratKeluarHistoryState(this.data, {this.horizontal = true});

  DetailTrackingSuratKeluarHistoryState.vertical(this.data): horizontal = false;
  ...
  Future<DetailTrackingSuratKeluarModel> makeRequest() async {
    ...
    final response =
    await http.get(URL_DETAIL_TRACKING_SURAT_KELUAR + data.toString() +"?token=" +loginToken);
