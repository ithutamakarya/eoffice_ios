...
import 'package:eoffice/model/suratkeluar/SuratKeluarModel.dart';
...
class SuratKeluarRoute extends CupertinoPageRoute {
  SuratKeluarRoute()
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    return new FadeTransition(opacity: animation, child: new SuratKeluar());
  }
}

class SuratKeluar extends StatefulWidget {
  static const String routeName = "/SuratKeluar";
...
class SuratKeluarState extends State<SuratKeluar> with WidgetsBindingObserver {
  ...
  static List<SuratKeluarList> items = new List();
  static List<SuratKeluarList> itemss = new List();
  ...
  Future<SuratKeluarModel> makeRequest() async {
